...
if __name__ == "__main__":
    ...
    queries = np.random.rand(160,3).astype(np.float32)
    supports = np.random.rand(160,3).astype(np.float32)
    # qb = torch.tensor([10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10])
    # sb = torch.tensor([10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10])
    # queries, supports, q_batches, s_batches, radius
    q_batches = np.array([40,40,40,40]).astype(np.int32)
    s_batches = np.array([40,40,40,40]).astype(np.int32)
    
    radius = 0.0625
    
    batch_neighbors_kpconv(queries, supports, q_batches, s_batches, radius)
