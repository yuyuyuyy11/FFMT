...
class URes18Encoder1_redc(nn.Module):
    def __init__(self, chan_in=3, chan_out=32, pretrained=False):
        super().__init__()
        resnet1 = resnet18(pretrained=pretrained)
        self.inconv = ConvBlock(chan_in, 32, k=3)
...
def test01():
    model = URes18Encoder1(3, 32, False)
    print(model.layer2)

def test02():
    model = URes18Encoder1_redc(3, 32, False)
    print(model.layer1)
